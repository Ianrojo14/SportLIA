        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    ...
                    <p>
                        Somos una empresa que quiere dar oportunidad y facilidad a encontrar su equipo necesario para sus actividades deportivas
                    </p>
                </div>
                <div class="col-md-4">
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                   Ofrecemos muchas maneras de servicio al cliente como mostramos
                </p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Servicios de entregas</h2>
                </div>
            </div>
